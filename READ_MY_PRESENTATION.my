...
Глобальный дневник
  ...
  При завершение регистрации можно будет (по желанию) пройти небольшой опрос🌿🌱. после чево бот сумирует информацию и выдает лучший вариант решения глобального потепления специально для вас.
